 ...
 */
var e;const t=window,s=t.trustedTypes,i=s?s.createPolicy("lit-html",{createHTML:e=>e}):void 0,n=`lit$${(Math.random()+"").slice(9)}$`,r="?"+n,o=`<${r}>`,a=document,d=(e="")=>a.createComment(e),l=e=>null===e||"object"!=typeof e&&"function"!=typeof e,c=Array.isArray,h=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,u=/-->/g,g=/>/g,p=RegExp(">|[ \t\n\f\r](?:([^\\s\"'>=/]+)([ \t\n\f\r]*=[ \t\n\f\r]*(?:[^ \t\n\f\r\"'`<>=]|(\"|')|))|$)","g"),m=/'/g,v=/"/g,b=/^(?:script|style|textarea|title)$/i,f=(e=>(t,...s)=>({_$litType$:e,strings:t,values:s}))(1),y=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),A=new WeakMap,w=(e,t,s)=>{var i,n;const r=null!==(i=null==s?void 0:s.renderBefore)&&void 0!==i?i:t;let o=r._$litPart$;if(void 0===o){const e=null!==(n=null==s?void 0:s.renderBefore)&&void 0!==n?n:null;r._$litPart$=o=new S(t.insertBefore(d(),e),e,void 0,null!=s?s:{})}return o._$AI(e),o},E=a.createTreeWalker(a,129,null,!1),C=(e,t)=>{const s=e.length-1,r=[];let a,d=2===t?"<svg>":"",l=h;for(let t=0;t<s;t++){const s=e[t];let i,c,f=-1,y=0;for(;y<s.length&&(l.lastIndex=y,c=l.exec(s),null!==c);)y=l.lastIndex,l===h?"!--"===c[1]?l=u:void 0!==c[1]?l=g:void 0!==c[2]?(b.test(c[2])&&(a=RegExp("</"+c[2],"g")),l=p):void 0!==c[3]&&(l=p):l===p?">"===c[0]?(l=null!=a?a:h,f=-1):void 0===c[1]?f=-2:(f=l.lastIndex-c[2].length,i=c[1],l=void 0===c[3]?p:'"'===c[3]?v:m):l===v||l===m?l=p:l===u||l===g?l=h:(l=p,a=void 0);const $=l===p&&e[t+1].startsWith("/>")?" ":"";d+=l===h?s+o:f>=0?(r.push(i),s.slice(0,f)+"$lit$"+s.slice(f)+n+$):s+n+(-2===f?(r.push(void 0),t):$)}const c=d+(e[s]||"<?>")+(2===t?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==i?i.createHTML(c):c,r]};class I{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let a=0,l=0;const c=e.length-1,h=this.parts,[u,g]=C(e,t);if(this.el=I.createElement(u,i),E.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(o=E.nextNode())&&h.length<c;){if(1===o.nodeType){if(o.hasAttributes()){const e=[];for(const t of o.getAttributeNames())if(t.endsWith("$lit$")||t.startsWith(n)){const s=g[l++];if(e.push(t),void 0!==s){const e=o.getAttribute(s.toLowerCase()+"$lit$").split(n),t=/([.?@])?(.*)/.exec(s);h.push({type:1,index:a,name:t[2],strings:e,ctor:"."===t[1]?L:"?"===t[1]?T:"@"===t[1]?N:_})}else h.push({type:6,index:a})}for(const t of e)o.removeAttribute(t)}if(b.test(o.tagName)){const e=o.textContent.split(n),t=e.length-1;if(t>0){o.textContent=s?s.emptyScript:"";for(let s=0;s<t;s++)o.append(e[s],d()),E.nextNode(),h.push({type:2,index:++a});o.append(e[t],d())}}}else if(8===o.nodeType)if(o.data===r)h.push({type:2,index:a});else{let e=-1;for(;-1!==(e=o.data.indexOf(n,e+1));)h.push({type:7,index:a}),e+=n.length-1}a++}}static createElement(e,t){const s=a.createElement("template");return s.innerHTML=e,s}}function M(e,t,s=e,i){var n,r,o,a;if(t===y)return t;let d=void 0!==i?null===(n=s._$Cl)||void 0===n?void 0:n[i]:s._$Cu;const c=l(t)?void 0:t._$litDirective$;return(null==d?void 0:d.constructor)!==c&&(null===(r=null==d?void 0:d._$AO)||void 0===r||r.call(d,!1),void 0===c?d=void 0:(d=new c(e),d._$AT(e,s,i)),void 0!==i?(null!==(o=(a=s)._$Cl)&&void 0!==o?o:a._$Cl=[])[i]=d:s._$Cu=d),void 0!==d&&(t=M(e,d._$AS(e,t.values),d,i)),t}class k{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:s},parts:i}=this._$AD,n=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:a).importNode(s,!0);E.currentNode=n;let r=E.nextNode(),o=0,d=0,l=i[0];for(;void 0!==l;){if(o===l.index){let t;2===l.type?t=new S(r,r.nextSibling,this,e):1===l.type?t=new l.ctor(r,l.name,l.strings,this,e):6===l.type&&(t=new O(r,this,e)),this.v.push(t),l=i[++d]}o!==(null==l?void 0:l.index)&&(r=E.nextNode(),o++)}return n}m(e){let t=0;for(const s of this.v)void 0!==s&&(void 0!==s.strings?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class S{constructor(e,t,s,i){var n;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$C_=null===(n=null==i?void 0:i.isConnected)||void 0===n||n}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$C_}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=M(this,e,t),l(e)?e===$||null==e||""===e?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==y&&this.$(e):void 0!==e._$litType$?this.T(e):void 0!==e.nodeType?this.k(e):(e=>c(e)||"function"==typeof(null==e?void 0:e[Symbol.iterator]))(e)?this.O(e):this.$(e)}S(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.S(e))}$(e){this._$AH!==$&&l(this._$AH)?this._$AA.nextSibling.data=e:this.k(a.createTextNode(e)),this._$AH=e}T(e){var t;const{values:s,_$litType$:i}=e,n="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=I.createElement(i.h,this.options)),i);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===n)this._$AH.m(s);else{const e=new k(n,this),t=e.p(this.options);e.m(s),this.k(t),this._$AH=e}}_$AC(e){let t=A.get(e.strings);return void 0===t&&A.set(e.strings,t=new I(e)),t}O(e){c(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,i=0;for(const n of e)i===t.length?t.push(s=new S(this.S(d()),this.S(d()),this,this.options)):s=t[i],s._$AI(n),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$C_=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class _{constructor(e,t,s,i,n){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,i){const n=this.strings;let r=!1;if(void 0===n)e=M(this,e,t,0),r=!l(e)||e!==this._$AH&&e!==y,r&&(this._$AH=e);else{const i=e;let o,a;for(e=n[0],o=0;o<n.length-1;o++)a=M(this,i[s+o],t,o),a===y&&(a=this._$AH[o]),r||(r=!l(a)||a!==this._$AH[o]),a===$?e=$:e!==$&&(e+=(null!=a?a:"")+n[o+1]),this._$AH[o]=a}r&&!i&&this.P(e)}P(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class L extends _{constructor(){super(...arguments),this.type=3}P(e){this.element[this.name]=e===$?void 0:e}}const x=s?s.emptyScript:"";class T extends _{constructor(){super(...arguments),this.type=4}P(e){e&&e!==$?this.element.setAttribute(this.name,x):this.element.removeAttribute(this.name)}}class N extends _{constructor(e,t,s,i,n){super(e,t,s,i,n),this.type=5}_$AI(e,t=this){var s;if((e=null!==(s=M(this,e,t,0))&&void 0!==s?s:$)===y)return;const i=this._$AH,n=e===$&&i!==$||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==$&&(i===$||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==s?s:this.element,e):this._$AH.handleEvent(e)}}class O{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){M(this,e)}}const H=t.litHtmlPolyfillSupport;null==H||H(I,S),(null!==(e=t.litHtmlVersions)&&void 0!==e?e:t.litHtmlVersions=[]).push("2.3.1");class q extends HTMLElement{#e;static get observedAttributes(){return["visible"]}get type(){return this.getAttribute("type")}get message(){return this.getAttribute("message")}get visible(){return this.getAttribute("visible")}set visible(e){this.setAttribute("visible",e)}connectedCallback(){this.#t(),setTimeout((()=>{this.#e=this.message,this.removeAttribute("message"),this.visible="visible"}),50),setTimeout((()=>{this.visible="",setTimeout((()=>this.remove()),225)}),4e3)}attributeChangedCallback(e,t,s){"visible"===e&&t!==s&&this.#t()}#t(){w(f`
			<div class='toast ${this.type} ${this.visible}' role='alert'>
				${this.#e}
			</div>
		`,this)}}class P extends HTMLElement{#s;static get observedAttributes(){return["list"]}get list(){return this.getAttribute("list").split(",").filter((e=>e))}set list(e){this.setAttribute("list",e)}connectedCallback(){this.#s=this.closest("div, article").querySelector("input"),this.#t()}attributeChangedCallback(e,t,s){"list"===e&&t!==s&&this.#t()}#i(e){e&&(this.#s.value=e),this.#s.focus(),this.dispatchEvent(new CustomEvent("listReset"))}#t(){w(this.list.length?f`
			<div class='propose'>
				${this.list.map((e=>f`
							<a
									href="#"
		...
		`,this)}}class j{static strings={ordered:"Acheté",gram:"Gr",centiliter:"Cl",number:"Nb",gramComplete:"Gramme",centiliterComplete:"Centilitre",numberComplete:"Nombre"};static renderAddIngredientInDialog(e,t){const s=document.querySelector("fs-confirm > dialog > article");w(t?"":f`
			<div class="addIngredient">
				<input
						autocomplete="off" class="ingredient" name="ingredient" required type="text" value="${e?.title}"
						@input="${e=>document.body.dispatchEvent(new CustomEvent("modalConfirm",{detail:{event:e}}))}"
						@keyup="${s=>{"Enter"!==s.key&&(j.managePropositions(s),this.renderAddIngredientInDialog(e,t))}}"/>
				<fs-propose list="${j.propositions}" @listReset="${()=>{j.setPropositions(),this.renderAddIngredientInDialog(e,t)}}"></fs-propose>
			</div>
			<input autocomplete="off" class="size" name="size" type="number" value="${e?.size}" @change="${e=>document.body.dispatchEvent(new CustomEvent("modalConfirm",{detail:{event:e}}))}"/>
			<select class="unit" name="'unit'" @input="${e=>document.body.dispatchEvent(new CustomEvent("modalConfirm",{detail:{event:e}}))}">
				<option class="nb" ?selected="${"nb"===e?.unit}" value="nb">${this.strings.numberComplete}</option>
				<option class="g" ?selected="${"g"===e?.unit}" value="g">${this.strings.gramComplete}</option>
				<option class="cl" ?selected="${"cl"===e?.unit}" value="cl">${this.strings.centiliterComplete}</option>
			</select>
		`,s,{renderBefore:s.querySelector("footer")})}static setPropositions(e){this.savedIngredients&&this.savedIngredients.length&&(this.propositions=e?this.savedIngredients.length&&this.savedIngredients.map((e=>e.title)).filter((t=>t.toLowerCase().includes(e.toLowerCase()))):[])}static clearPropositionsOnBackgroundClick(e){document.body.addEventListener("click",(t=>{t.target.closest("div.propose")||(this.setPropositions(),e())}))}static managePropositions(e,t){const s=e.target;this.setPropositions(s.value),"ArrowDown"===e.key&&this.propositions?s.closest("article").querySelector("fs-propose a:first-child").focus():(0===s.value.length||this.propositions.length&&1===this.propositions.length&&this.propositions[0].toLowerCase()===s.value?.toLowerCase())&&(this.propositions[0]?.toLowerCase()===s.value?.toLowerCase()&&(s.value=this.propositions[0]),this.setPropositions())}}j.savedIngredients=[];class V extends HTMLElement{#f;#y;#$;#A;#w;#E;#C;#I;#M;async connectedCallback(){j.clearPropositionsOnBackgroundClick((()=>this.#t()));const e=location.pathname.split("/");this.#f="Ajouter",this.#y="Ajouter une recette",this.#$=e.includes("edit"),this.#A=this.#$,this.#$?(this.#w=e[e.length-1],this.#E=R.get(`${this.#w}`)||await B.request("/db","POST",{body:`{ "getRecipes": { "slug": "${this.#w}" } }`}),R.set(this.#w,this.#E),Array.isArray(this.#E)&&(location.href=location.origin+"/404.html"),this.#C=this.#E.title,this.#I=this.#E._id,this.#f="Modifier",this.#y="Modifier une recette",this.#M=this.#E.ingredients):this.#M=[],j.savedIngredients=R.get("ingredients")||await B.request("/db","POST",{body:'{ "getIngredients": "" }'}),R.set("ingredients",j.savedIngredients),document.body.style.display="flex",this.#t(),this.#k()}#k(){const e=this.querySelector("form");e.addEventListener("keypress",(async e=>{"Enter"===e.key&&e.preventDefault()})),e.addEventListener("submit",(async t=>{t.preventDefault();try{const t=Object.fromEntries(new FormData(e).entries()),s=t.id,i=Object.keys(t).reduce(((e,s)=>{if("recipe"!==s&&"id"!==s&&(!e.some((e=>e.title===t[s]))&&s.includes("ingredient")&&e.push({title:t[s]}),!s.includes("ingredient"))){const i=s.split("_");e[0===Number(i[1])?e.length-1:Number(i[1])-1][i[0]]=t[s]}return e}),[]);this.#$&&(this.#E.ingredients=i,R.set(this.#w,this.#E)),B.loader(!0);const n=await B.request("/db","POST",{body:`{ "setRecipe": { "title": "${t.recipe}", ${s?`"id": "${s}",`:""} "ingredients": ${JSON.stringify(i)}} }`});R.set("recipes",n[0]),B.loader(!1),this.#$?location.href="/app/recipes":(this.#M=[],document.querySelectorAll("input").forEach((e=>{e.value=""})),B.toast("success","Recette enregistrée"),j.savedIngredients=n[1],R.set("ingredients",j.savedIngredients),this.#t())}catch(e){console.error(e)}}))}#S(e,t){const s=e.target.closest("article"),i=s.querySelector(".ingredient"),n=s.querySelector(".size"),r=s.querySelector(".unit");if(i?.value){const e={title:i.value,size:n.value,unit:r.value};void 0!==t?this.#M[t]=e:this.#M.push(e),this.#t()}}#v(e){j.setPropositions(),this.#M.splice(e,1),this.#t()}#_(e,t){let s;document.body.addEventListener("modalConfirm",(e=>{s=e.detail.event})),B.confirm(f``,(async()=>{void 0!==t?this.#S(s,t):this.#S(s),j.renderAddIngredientInDialog(e,!0)}),(()=>j.renderAddIngredientInDialog(e,!0))),j.renderAddIngredientInDialog(e)}#t(){w(f`
			<h2>${this.#y}</h2>
			<form>
				<label>
					<span>Nom</span>
					<input autocomplete="off" name="recipe" required type="text" value="${this.#C||""}">
					<input name="id" type="hidden" value="${this.#I||""}">
				</label>
				<fieldset class="ingredients">
					<div class="title">
						<legend>Ingrédients</legend>
						<button type="button" class="add" @click="${()=>this.#_()}">
							<svg class="add">
								<use href="#add"></use>
							</svg>
					...
					${this.#M?.map(((e,t)=>f`
								<div class="grid">
									<span>${e?.title||e}${e?.size?` (${e?.size}${e?.unit&&"nb"!==e?.unit?` ${e?.unit}`:""})`:""}</span>
									...
									<button type="button" class="edit" @click="${()=>this.#_(e,t)}">
										<svg class="edit">
											<use href="#edit"></use>
										</svg>
		...
		`,(async()=>{const e=await B.request("/db","POST",{body:`[{ "setListIngredients": { "ingredients": [ { "title": "${s}", "id": "${t}", "category": "${i}" } ] } }, { "getIngredients": "" }]`});this.#u=e[0],j.savedIngredients=e[1],R.set("listIngredients",this.#u,"ingredients",j.savedIngredients),this.#N()}))}#R(){B.confirm(f`<h3>Voulez vous vider la liste ?</h3>`,(async()=>{this.#x=[],this.#u=await B.request("/db","POST",{body:'{ "clearListIngredients": "" }'}),R.set("listIngredients",this.#u),this.#N()}))}#_(e){let t;document.body.addEventListener("modalConfirm",(e=>{t=e.detail.event})),B.confirm(f``,(async()=>{await this.#O(t,e?._id),j.renderAddIngredientInDialog(e,!0)}),(()=>j.renderAddIngredientInDialog(e,!0))),j.renderAddIngredientInDialog(e)}#t(){const e=e=>{const t=e._id,s=e.title,i=e.size,n=e.unit,r=this.#x?.includes(t);return f`
			...
			<div class="title">
				...
				<button type="button" class="addList" @click="${()=>this.#P()}">
					<svg class="addList">
						<use href="#addList"></use>
					</svg>
					<span>Ajouter des ingrédients</span>
				</button>
				<button type="button" class="trash" @click="${()=>this.#R()}">
					<svg class="trash">
						<use href="#trash"></use>
					</svg>
					<span>Vider</span>
		...
		`,this)}}class ye extends HTMLElement{connectedCallback(){this.#t(),this.#k()}#k(){const e=this.querySelector("form");e.addEventListener("submit",(async t=>{t.preventDefault(),await B.request("/auth","POST",{body:JSON.stringify(Object.fromEntries(new FormData(e).entries()))}),location.href="/app"}))}#t(){w(f`
			<form>
				<label>
						...
						<li>
							${null===this.choiceMode?f`
										<div class="addCategory grid">
											<input name="newCategory" type="text" @keyup="${e=>{"Enter"===e.key&&this.#B(e)}}"/>
											<button type="button" class="add" @click="${e=>this.#B(e)}">
												<svg class="add">
													<use href="#add"></use>
												</svg>
									...
									`:f`
										<li>
											<div class="editCategory ${this.#h===s?"grid":""}">
												${this.#h===s?f`
													<input name="editCategory" required type="text" value="${t}" @keyup="${e=>{"Enter"===e.key&&this.#B(e,s),"Escape"===e.key&&this.#m()}}"/>`:f`
													<span>${t}</span>
												`}
												${this.#h===s?f`
													<button class="valid" @click="${e=>this.#B(e,s)}">
														<svg class="valid">
															<use href="#valid"></use>
														</svg>
														<span>Valider</span>
												...
												`:f`
													<button type="button" class="remove" @click="${()=>this.#D(s)}">
														<svg class="remove">
															<use href="#remove"></use>
														</svg>
														<span>Supprimer</span>
		...
		`,this)}}class we extends HTMLElement{static get observedAttributes(){return["visible"]}get visible(){return this.hasAttribute("visible")}set visible(e){e?this.setAttribute("visible",""):this.removeAttribute("visible")}connectedCallback(){this.#t(),this.style.display="none"}attributeChangedCallback(e,t,s){"visible"===e&&t!==s&&(""===s&&(this.style.display="",setTimeout((()=>this.#t()),20)),null===s&&(this.style.display="none",setTimeout((()=>this.#t()),20)))}#t(){w(f`
			...
			<slot></slot>
		`,this)}}class Ce extends HTMLElement{#V;#U;#F;#J;#Y;#G;async connectedCallback(){this.#V=["Lundi","mardi","Mercredi","Jeudi","Vendredi","Samedi","Dimanche"],this.#U={Midi:this.#V,Soir:this.#V};const e=R.get("dishes","ingredients")||await B.request("/db","POST",{body:'[{ "getDishes": "" }, { "getIngredients": "" }]'});R.set("dishes",e[0],"ingredients",e[1]),this.#F=e[0],j.savedIngredients=e[1],this.#Z()}#X(e,t,s){e.target.closest("details").removeAttribute("open"),document.body.addEventListener("modalConfirm",(e=>{this.#J=e.detail.dishName||e.detail.title,this.#Y=e.detail.choices&&e.detail.choices[0]||null})),B.confirm(s?f`
			<label for="firstname">
		...
		`,(async()=>{if(this.#J&&(t.name=this.#J,this.#F=await B.request("/db","POST",{body:`{ "setDish": ${JSON.stringify(t)} }`}),R.set("dishes",this.#F)),this.#Z(),!s&&this.#J){const e=j.savedIngredients.filter((e=>e.recipes?.length&&e.recipes.some((e=>this.#Y===e)))).map((e=>({title:e.title,category:e.category}))),t=await B.request("/db","POST",{body:`{ "setListIngredients": { "ingredients": ${JSON.stringify(e)} } }`});R.set("listIngredients",t),ve.send(t)}this.#J=""}))}#Z(){this.#G=this.#F.reduce(((e,t)=>(e[t.time]=e[t.time]??{},e[t.time][t.day]=e[t.time][t.day]??{},e[t.time][t.day]=t,e)),{}),this.#t()}#R(e,t){e&&e.target.closest("details").removeAttribute("open"),B.confirm(f`<h3>Voulez vous effacer ${t?"ce plat":"les plats de la semaine"} ?</h3>`,(async()=>{this.#F=await B.request("/db","POST",{body:`{ "clearDishes": "${t||""}" }`}),R.set("dishes",this.#F),this.#Z()}))}#t(){w(f`
			<div class="title">
			...
			<div class="content">
				...
				${Object.entries(this.#U).map((([e,t])=>f`
						<div class="grid">
							<div>${e}</div>
							${t.map((t=>{const s=(this.#G[e]&&this.#G[e][t])??{time:e,day:t};return f`
									<details role="list">
										<summary aria-haspopup="listbox" role="button">${s.name}</summary>
										<ul role="listbox">
											<li>
												<button @click="${e=>this.#X(e,s,!0)}">Éditer</button>
											</li>
											<li>
												<button @click="${e=>this.#X(e,s)}">Ajouter</button>
											</li>
											${s._id&&f`
												<li>
													<button @click="${e=>this.#R(e,s._id)}">Effacer</button>
												</li>
											`}
										</ul>
									</details>
		...
		`,this)}}class Ie extends HTMLElement{get href(){return this.getAttribute("href")}set href(e){this.setAttribute("open",e)}async connectedCallback(){const e=Array.from(this.children);this.#t(),this.querySelector("slot")?.replaceWith(...e);const t=await B.getFragmentHtml(this.href);this.addEventListener("click",(()=>{history.pushState({},"",this.href),Me(t)}))}#t(){w(f`
			<slot></slot>
		`,this)}}const Me=e=>{document.querySelector("[data-replaced-zone]").replaceChildren(document.createRange().createContextualFragment(e.text)),document.body.className=e.class,document.querySelector("[data-replaced-title]").innerHTML=e.title};window.addEventListener("popstate",(async()=>Me(await B.getFragmentHtml(location.pathname))));class ke extends HTMLElement{#K;#Q;#ee;constructor(){super(),this.style.display="none"}async connectedCallback(){this.#K=R.get("routes")||await B.request("/app/routes.json"),R.set("routes",this.#K),this.removeAttribute("style"),this.#te(),window.addEventListener("resize",(e=>this.#te())),window.addEventListener("popstate",(()=>this.#t()))}#te(){this.#Q=window.innerWidth<=1100,this.#ee=window.innerWidth<=1100,this.#Q?this.setAttribute("data-burger",""):this.removeAttribute("data-burger"),this.#t()}#t(){w(f`
			${this.#Q?f`
				<button class="burger" @click="${()=>{this.#ee=!1,this.#t()}}">
					<svg class="burger">
						<use href="#burger"></use>
					</svg>
			...
			`:""}
			<div data-hidden="${this.#ee}">
				${this.#Q?f`
					<button class="back" @click="${()=>{this.#ee=!0,this.#t()}}">
						<svg class="back">
							<use href="#back"></use>
							<span>Retour</span>
						</svg>
				...
				<ul>
					${this.#K.map((e=>f`
						<li data-selected="${e.path===location.pathname}" @click="${()=>this.#te()}">
		...
		`,this)}}new class{constructor(){B.helpers(),this.wakeLock(),ve.init(),"/"===location.href.charAt(location.href.length-1)&&history.replaceState({},"",location.href.replace(/\/$/,""))}async wakeLock(){let e=null;const t=async()=>{try{e=await navigator.wakeLock.request()}catch(e){console.error(`${e.name}, ${e.message}`)}};document.addEventListener("visibilitychange",(async()=>{null!==e&&"visible"===document.visibilityState&&await t()})),await t()}},customElements.define("fs-loader",we),customElements.define("fs-header",fe),customElements.define("fs-toast",q),customElements.define("fs-confirm",D),customElements.define("fs-propose",P),customElements.define("fs-recipes",z),customElements.define("fs-recipe",V),customElements.define("fs-lists",be),customElements.define("fs-ingredients",W),customElements.define("fs-categories",$e),customElements.define("fs-login",ye),customElements.define("fs-loading-block",Ee),customElements.define("fs-animated-section",Ae),customElements.define("fs-dishes",Ce),customElements.define("fs-link",Ie),customElements.define("fs-menu",ke);
