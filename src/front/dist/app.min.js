...
var e;const t=window,s=t.trustedTypes,i=s?s.createPolicy("lit-html",{createHTML:e=>e}):void 0,n=`lit$${(Math.random()+"").slice(9)}$`,r="?"+n,o=`<${r}>`,a=document,d=(e="")=>a.createComment(e),l=e=>null===e||"object"!=typeof e&&"function"!=typeof e,c=Array.isArray,h=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,u=/-->/g,p=/>/g,g=RegExp(">|[ \t\n\f\r](?:([^\\s\"'>=/]+)([ \t\n\f\r]*=[ \t\n\f\r]*(?:[^ \t\n\f\r\"'`<>=]|(\"|')|))|$)","g"),m=/'/g,v=/"/g,f=/^(?:script|style|textarea|title)$/i,b=(e=>(t,...s)=>({_$litType$:e,strings:t,values:s}))(1),y=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),A=new WeakMap,w=(e,t,s)=>{var i,n;const r=null!==(i=null==s?void 0:s.renderBefore)&&void 0!==i?i:t;let o=r._$litPart$;if(void 0===o){const e=null!==(n=null==s?void 0:s.renderBefore)&&void 0!==n?n:null;r._$litPart$=o=new _(t.insertBefore(d(),e),e,void 0,null!=s?s:{})}return o._$AI(e),o},C=a.createTreeWalker(a,129,null,!1),E=(e,t)=>{const s=e.length-1,r=[];let a,d=2===t?"<svg>":"",l=h;for(let t=0;t<s;t++){const s=e[t];let i,c,b=-1,y=0;for(;y<s.length&&(l.lastIndex=y,c=l.exec(s),null!==c);)y=l.lastIndex,l===h?"!--"===c[1]?l=u:void 0!==c[1]?l=p:void 0!==c[2]?(f.test(c[2])&&(a=RegExp("</"+c[2],"g")),l=g):void 0!==c[3]&&(l=g):l===g?">"===c[0]?(l=null!=a?a:h,b=-1):void 0===c[1]?b=-2:(b=l.lastIndex-c[2].length,i=c[1],l=void 0===c[3]?g:'"'===c[3]?v:m):l===v||l===m?l=g:l===u||l===p?l=h:(l=g,a=void 0);const $=l===g&&e[t+1].startsWith("/>")?" ":"";d+=l===h?s+o:b>=0?(r.push(i),s.slice(0,b)+"$lit$"+s.slice(b)+n+$):s+n+(-2===b?(r.push(void 0),t):$)}const c=d+(e[s]||"<?>")+(2===t?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==i?i.createHTML(c):c,r]};class k{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let a=0,l=0;const c=e.length-1,h=this.parts,[u,p]=E(e,t);if(this.el=k.createElement(u,i),C.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(o=C.nextNode())&&h.length<c;){if(1===o.nodeType){if(o.hasAttributes()){const e=[];for(const t of o.getAttributeNames())if(t.endsWith("$lit$")||t.startsWith(n)){const s=p[l++];if(e.push(t),void 0!==s){const e=o.getAttribute(s.toLowerCase()+"$lit$").split(n),t=/([.?@])?(.*)/.exec(s);h.push({type:1,index:a,name:t[2],strings:e,ctor:"."===t[1]?L:"?"===t[1]?T:"@"===t[1]?N:I})}else h.push({type:6,index:a})}for(const t of e)o.removeAttribute(t)}if(f.test(o.tagName)){const e=o.textContent.split(n),t=e.length-1;if(t>0){o.textContent=s?s.emptyScript:"";for(let s=0;s<t;s++)o.append(e[s],d()),C.nextNode(),h.push({type:2,index:++a});o.append(e[t],d())}}}else if(8===o.nodeType)if(o.data===r)h.push({type:2,index:a});else{let e=-1;for(;-1!==(e=o.data.indexOf(n,e+1));)h.push({type:7,index:a}),e+=n.length-1}a++}}static createElement(e,t){const s=a.createElement("template");return s.innerHTML=e,s}}function M(e,t,s=e,i){var n,r,o,a;if(t===y)return t;let d=void 0!==i?null===(n=s._$Cl)||void 0===n?void 0:n[i]:s._$Cu;const c=l(t)?void 0:t._$litDirective$;return(null==d?void 0:d.constructor)!==c&&(null===(r=null==d?void 0:d._$AO)||void 0===r||r.call(d,!1),void 0===c?d=void 0:(d=new c(e),d._$AT(e,s,i)),void 0!==i?(null!==(o=(a=s)._$Cl)&&void 0!==o?o:a._$Cl=[])[i]=d:s._$Cu=d),void 0!==d&&(t=M(e,d._$AS(e,t.values),d,i)),t}class S{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:s},parts:i}=this._$AD,n=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:a).importNode(s,!0);C.currentNode=n;let r=C.nextNode(),o=0,d=0,l=i[0];for(;void 0!==l;){if(o===l.index){let t;2===l.type?t=new _(r,r.nextSibling,this,e):1===l.type?t=new l.ctor(r,l.name,l.strings,this,e):6===l.type&&(t=new O(r,this,e)),this.v.push(t),l=i[++d]}o!==(null==l?void 0:l.index)&&(r=C.nextNode(),o++)}return n}m(e){let t=0;for(const s of this.v)void 0!==s&&(void 0!==s.strings?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class _{constructor(e,t,s,i){var n;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=i,this._$C_=null===(n=null==i?void 0:i.isConnected)||void 0===n||n}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$C_}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=M(this,e,t),l(e)?e===$||null==e||""===e?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==y&&this.$(e):void 0!==e._$litType$?this.T(e):void 0!==e.nodeType?this.k(e):(e=>c(e)||"function"==typeof(null==e?void 0:e[Symbol.iterator]))(e)?this.O(e):this.$(e)}S(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.S(e))}$(e){this._$AH!==$&&l(this._$AH)?this._$AA.nextSibling.data=e:this.k(a.createTextNode(e)),this._$AH=e}T(e){var t;const{values:s,_$litType$:i}=e,n="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=k.createElement(i.h,this.options)),i);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===n)this._$AH.m(s);else{const e=new S(n,this),t=e.p(this.options);e.m(s),this.k(t),this._$AH=e}}_$AC(e){let t=A.get(e.strings);return void 0===t&&A.set(e.strings,t=new k(e)),t}O(e){c(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,i=0;for(const n of e)i===t.length?t.push(s=new _(this.S(d()),this.S(d()),this,this.options)):s=t[i],s._$AI(n),i++;i<t.length&&(this._$AR(s&&s._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$C_=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class I{constructor(e,t,s,i,n){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=n,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,i){const n=this.strings;let r=!1;if(void 0===n)e=M(this,e,t,0),r=!l(e)||e!==this._$AH&&e!==y,r&&(this._$AH=e);else{const i=e;let o,a;for(e=n[0],o=0;o<n.length-1;o++)a=M(this,i[s+o],t,o),a===y&&(a=this._$AH[o]),r||(r=!l(a)||a!==this._$AH[o]),a===$?e=$:e!==$&&(e+=(null!=a?a:"")+n[o+1]),this._$AH[o]=a}r&&!i&&this.P(e)}P(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class L extends I{constructor(){super(...arguments),this.type=3}P(e){this.element[this.name]=e===$?void 0:e}}const x=s?s.emptyScript:"";class T extends I{constructor(){super(...arguments),this.type=4}P(e){e&&e!==$?this.element.setAttribute(this.name,x):this.element.removeAttribute(this.name)}}class N extends I{constructor(e,t,s,i,n){super(e,t,s,i,n),this.type=5}_$AI(e,t=this){var s;if((e=null!==(s=M(this,e,t,0))&&void 0!==s?s:$)===y)return;const i=this._$AH,n=e===$&&i!==$||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==$&&(i===$||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==s?s:this.element,e):this._$AH.handleEvent(e)}}class O{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){M(this,e)}}const P=t.litHtmlPolyfillSupport;null==P||P(k,_),(null!==(e=t.litHtmlVersions)&&void 0!==e?e:t.litHtmlVersions=[]).push("2.3.1");class q extends HTMLElement{static get observedAttributes(){return["visible"]}get type(){return this.getAttribute("type")}get message(){return this.getAttribute("message")}get visible(){return this.getAttribute("visible")}set visible(e){this.setAttribute("visible",e)}connectedCallback(){this.render(),setTimeout((()=>{this.messageProperty=this.message,this.removeAttribute("message"),this.visible="visible"}),50),setTimeout((()=>{this.visible="",setTimeout((()=>this.remove()),225)}),4e3)}attributeChangedCallback(e,t,s){"visible"===e&&t!==s&&this.render()}render(){w(b`
		...
		`,this)}}class Ee extends HTMLElement{get href(){return this.getAttribute("href")}set href(e){this.setAttribute("open",e)}async connectedCallback(){const e=Array.from(this.children);this.render(),this.querySelector("slot").replaceWith(...e);const t=await Me(this.href);this.addEventListener("click",(()=>{history.pushState({},"",this.href),ke(t)}))}render(){w(b`
			<slot></slot>
		`,this)}}const ke=e=>{document.querySelector("[data-replaced-zone]").replaceChildren(document.createRange().createContextualFragment(e.text)),document.body.className=e.class,document.querySelector("[data-replaced-title]").innerHTML=e.title},Me=async e=>{const t=JSON.parse(sessionStorage.getItem(e))||await R.request(e,"POST");return sessionStorage.setItem(e,JSON.stringify(t)),t};window.onpopstate=async()=>ke(await Me(location.pathname)),Me(location.pathname);new class{constructor(){this.setBackButton(),R.helpers(),this.wakeLock()}async wakeLock(){let e=null;const t=async()=>{try{e=await navigator.wakeLock.request()}catch(e){console.error(`${e.name}, ${e.message}`)}};document.addEventListener("visibilitychange",(async()=>{null!==e&&"visible"===document.visibilityState&&await t()})),await t()}setBackButton(){if(location.pathname.split("/").filter((e=>e)).length&&history.length>2){const e=B.newDom(document.querySelector("fs-header > div:first-child"));e.elt("a","back").att("role","button").att("href","#").listen("click",(()=>history.back())),e.svg("back").up(),e.elt("span").text("Retour").up(),e.up()}}},customElements.define("fs-loader",Ae),customElements.define("fs-header",fe),customElements.define("fs-toast",q),customElements.define("fs-confirm",W),customElements.define("fs-propose",H),customElements.define("fs-recipes",D),customElements.define("fs-recipe",z),customElements.define("fs-lists",ve),customElements.define("fs-ingredients",j),customElements.define("fs-categories",ye),customElements.define("fs-login",be),customElements.define("fs-loading-block",we),customElements.define("fs-animated-section",$e),customElements.define("fs-dishes",Ce),customElements.define("fs-link",Ee);
